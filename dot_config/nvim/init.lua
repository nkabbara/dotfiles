...
require("lazy").setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Shortcut for searching your Neovim configuration filesresume
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- this conflicts with sneak plugin. Trying https://github.com/kylechui/nvim-surround instead
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      require("nvim-treesitter").setup({
        -- Install parsers to standard location
